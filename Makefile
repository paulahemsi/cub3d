...
#    Updated: 2021/03/25 12:43:07 by phemsi-a         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
FILES = cub.c $(SRC)error.c $(SRC)parse_configs.c $(SRC)parse_map.c $(SRC)check_walls.c $(SRC)render_cub.c
OBJECTS = cub.o error.o parse_configs.o parse_map.o check_walls.o render_cub.o
