...
BONUS_FILES = $(SRC_BONUS)cub_b.c $(SYSTEM_BONUS)free_b.c $(SYSTEM_BONUS)save_bmp_b.c $(SYSTEM_BONUS)events_b.c $(SYSTEM_BONUS)error_b.c $(PARSE_BONUS)parse_scene_b.c $(PARSE_BONUS)parse_settings_b.c $(PARSE_BONUS)parse_map_b.c $(PARSE_BONUS)check_map_b.c $(PARSE_BONUS)load_textures_b.c $(RENDER_BONUS)render_cub_b.c $(RENDER_BONUS)render_tools_b.c $(RENDER_BONUS)put_line_b.c $(RENDER_BONUS)render_minimap_b.c $(RENDER_BONUS)put_background_b.c $(RENDER_BONUS)put_hud_b.c $(RENDER_BONUS)render_utils_b.c $(RENDER_BONUS)raycasting_b.c $(RENDER_BONUS)collisions_b.c $(RENDER_BONUS)put_walls_b.c $(RENDER_BONUS)put_sprites_b.c $(RENDER_BONUS)background_gradient_b.c $(RENDER_BONUS)night_vision_b.c $(RENDER_BONUS)wall_color_b.c $(RENDER_BONUS)check_tile_and_limits_b.c
BONUS_OBJECTS = cub_b.o free_b.o error_b.o parse_settings_b.o parse_map_b.o check_map_b.o render_cub_b.o events_b.o render_tools_b.o put_line_b.o render_minimap_b.o put_background_b.o render_utils_b.o raycasting_b.o put_walls_b.o save_bmp_b.o load_textures_b.o put_sprites_b.o collisions_b.o parse_scene_b.o background_gradient_b.o night_vision_b.o put_hud_b.o wall_color_b.o check_tile_and_limits_b.o
